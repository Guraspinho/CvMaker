const object = {
    ...
    certifications: [{ name: 'Certified JavaScript Developer', organization: 'XYZ' }]
  };
  ...
  if (object.visibility.certifications) {
    ...
    additionalInfoHTML += `<div class="Res1_additional_single">
      <span><b class="Res1_additional_single_b">Technical skills:</b><p class="Res1_additionals">${object.skills.join(', ')}</p></span>
    </div>`;
    additionalInfoHTML += `<div class="Res1_additional_single">
      <span><b>Languages:</b><p class="Res1_additionals">${object.languages.join(', ')}</p></span>
    </div>`;
    additionalInfoHTML += `<div class="Res1_additional_single">
      <span><b>Certifications:</b><p class="Res1_additionals">${object.certifications.map(cert => cert.name).join(', ')}</p></span>
    </div>`;
    additionalInfoHTML += `<div class="Res1_additional_single">
      <span><b>Awards/Activities:</b><p class="Res1_additionals">${object.certifications.map(cert => cert.organization).join(', ')}</p></span>
    </div>`;
